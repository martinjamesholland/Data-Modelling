-- Hub_Contact_Point for Data Vault 2.0
-- For use with Delta format on Hadoop and GCP BigQuery

CREATE TABLE IF NOT EXISTS data_vault.hub_contact_point (
    hub_contact_point_key STRING NOT NULL,    -- Surrogate key, generated hash
    contact_point_id STRING NOT NULL,         -- Business key
    ...
    -- Constraints
    CONSTRAINT pk_hub_contact_point PRIMARY KEY (hub_contact_point_key) NOT ENFORCED
)
...
CREATE TABLE IF NOT EXISTS data_vault.hub_contact_point (
    ...
    contact_point_id STRING NOT NULL,
