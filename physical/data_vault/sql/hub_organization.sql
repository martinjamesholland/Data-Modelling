-- Hub_Organization for Data Vault 2.0
-- For use with Delta format on Hadoop and GCP BigQuery

CREATE TABLE IF NOT EXISTS data_vault.hub_organization (
    hub_organization_key STRING NOT NULL,     -- Surrogate key, generated hash
    ...
    -- Constraints
    CONSTRAINT pk_hub_organization PRIMARY KEY (hub_organization_key) NOT ENFORCED
)
