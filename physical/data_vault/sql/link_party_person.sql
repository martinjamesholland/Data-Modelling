-- Link_Party_Person for Data Vault 2.0
-- For use with Delta format on Hadoop and GCP BigQuery

CREATE TABLE IF NOT EXISTS data_vault.link_party_person (
    link_party_person_key STRING NOT NULL,    -- Surrogate key, generated hash
    ...
    -- Constraints
    CONSTRAINT pk_link_party_person PRIMARY KEY (link_party_person_key) NOT ENFORCED
)
...
/*
CREATE TABLE IF NOT EXISTS data_vault.link_party_person (
    link_party_person_key STRING NOT NULL,
...
CLUSTER BY hub_party_key, hub_person_key;
*/ 