-- Hub_Agreement for Data Vault 2.0
-- For use with Delta format on Hadoop and GCP BigQuery

CREATE TABLE IF NOT EXISTS data_vault.hub_agreement (
    hub_agreement_key STRING NOT NULL,        -- Surrogate key, generated hash
    agreement_id STRING NOT NULL,             -- Business key
    ...
    -- Constraints
    CONSTRAINT pk_hub_agreement PRIMARY KEY (hub_agreement_key) NOT ENFORCED
)
