-- Hub_Location for Data Vault 2.0
-- For use with Delta format on Hadoop and GCP BigQuery

CREATE TABLE IF NOT EXISTS data_vault.hub_location (
    hub_location_key STRING NOT NULL,         -- Surrogate key, generated hash
    party_location_id STRING NOT NULL,        -- Business key
    ...
    -- Constraints
    CONSTRAINT pk_hub_location PRIMARY KEY (hub_location_key) NOT ENFORCED
)
...
CREATE TABLE IF NOT EXISTS data_vault.hub_location (
    ...
    party_location_id STRING NOT NULL,
